...
function initConfirmPayButtonEvent() {
    $('#confirmPayButton').click(function() {
        $.ajax({
            url: baseURL + 'action/auth/user/normal/PurchasingAreaGoodsOrderWholesaleAction/unifiedOrder',
            data: {
                channel: payment,
...
function balancePay(orderSn, payPwd) {
    ...
    $.ajax({
        url: baseURL + 'action/auth/user/normal/PurchasingAreaGoodsOrderWholesaleAction/balancePayCallBack',
        data: {
            orderSn: orderSn,
